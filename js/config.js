/**
 * Khedmah Frontend Configuration
 *
 * Production deployment: set KHEDMAH_API_URL to your live API base URL.
 * Example:  window.KHEDMAH_API_URL = 'https://api.khedmah.sa/api/v1';
 *
 * For local development this file can stay as-is — api.js falls back to
 * http://localhost:3000/api/v1 when KHEDMAH_API_URL is not set.
 *
